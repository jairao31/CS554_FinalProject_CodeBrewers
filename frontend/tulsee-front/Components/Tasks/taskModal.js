          ...
          <ModalBody>
            <form onSubmit={handleSubmit}>
                ...
                <CommonTextarea
                    ...
                    onChange={handleChange}
                />
                {currentProject && currentProject.type === "Group" && <UserAutocomplete allowSelf={true} label="Assignees" handleSelect={handleSelect} options={currentProject.participants}/>}
                {
